...
class RobotSpecs (models.Model):
    ...
    hybrid_score = ArceeFields.MultiSelectField (
        ...
        max_length = 20,
        choices = ROWS,
        verbose_name = 'Robot can score frisbees',
        help_text = 'Robot can score frisbees on these levels in autonomous mode',
    )
    tele_score = ArceeFields.MultiSelectField (
        ...
        choices = ROWS,
        verbose_name = 'Robot can score frisbees',
        help_text = 'Robot can score frisbees on these levels in teleoperation mode',
    )
    tele_time_score_bottom = models.IntegerField (
        default = 0,
        choices = GAME_TIME,
        verbose_name = 'Time to score 1 point',
        help_text = 'Time to score 1 point frisbees with scoring mechanism starting in rest state',
    )
    tele_time_score_middle = models.IntegerField (
        default = 0,
        choices = GAME_TIME,
        verbose_name = 'Time to score  2 point',
        help_text = 'Time to score 2 point frisbees with scoring mechanism starting in rest state',
    )
    tele_time_score_top = models.IntegerField (
        default = 0,
        choices = GAME_TIME,
        verbose_name = 'Time to score 3 point',
        help_text = 'Time to score 3 point frisbees with scoring mechanism starting in rest state',
    )
    ...
    balance_capable = models.NullBooleanField (
        ...
        verbose_name = 'Robot can climb',
        help_text = 'Robot can climb pyramid at the end of the match',
    )
    multi_balance_capable = models.IntegerField (
        default = 0,
        choices = LEVELS,
        verbose_name = 'Robot climb level',
        help_text = 'Robot can climb to this level at the end of the match',
    )
...
class MatchObservation (models.Model):
    HYBRID_ACTIONS = (
        ('NOA', 'No Activity'),
        ('HOB', 'Scored 1 Point Frisbees'),
        ('HOM', 'Scored 2 Point Frisbees'),
        ('HOT', 'Scored 3 Point Frisbees'),
        ('HAT', 'Attempted Score'),
        ('OTO', 'Other'),
    )
    TELE_SCORE = (
    ...
    red_yellow_card = models.CharField ( 
        ...
        verbose_name = 'Observed Team Earned Red/Yellow Card',
    )
    ...
    tele_hung_qty = models.IntegerField (
        default = 'N/A',
        choices = TELE_SCORE,
        verbose_name = 'Frisbees Scored',
    )
    tele_hung = ArceeFields.MultiSelectField (
        blank = True,
        max_length = 20,
        choices = RobotSpecs.ROWS,
        verbose_name = 'Robot scored goals',
        help_text = 'Robot scored in these goals in teleoperation mode',
    )
    tele_collected = models.CharField (
        max_length = 3,
        default = 'N/A',
        choices = TELE_COLLECT,
        verbose_name = 'Frisbees Collected From',
    )
    tele_dropped = models.IntegerField (
        default = 'N/A',
        choices = TELE_SCORE,
        verbose_name = 'Lost Frisbee(s)',
    )
    tele_damaged = models.IntegerField (
        default = 'N/A',
        choices = TELE_SCORE,
        verbose_name = 'Damaged Frisbee(s)',
    )
    tele_strategy = models.CharField (
        max_length = 3,
        default = 'NOP',
    ...
    balance_capable = models.NullBooleanField (
        ...
        verbose_name = 'Robot climbed',
        help_text = 'Robot climbed pyramid at the end of the match',
    )
    end_score = models.IntegerField (
        default = 0,
        choices = RobotSpecs.LEVELS,
        verbose_name = 'Robot level',
        help_text = 'Robot climbed to this level at the end of the match',
    )
    notes = models.TextField (
        blank = True,
        verbose_name = 'Additional Notes'
...
class PracticeObservation (models.Model):
    ...
    auto_action = models.CharField ( 
        default = 'NOA',
        max_length = 3,
        choices = MatchObservation.HYBRID_ACTIONS,
        verbose_name = 'Hybrid Action',
    )
    tele_hung_qty = models.IntegerField (
        default = 'N/A',
        choices = MatchObservation.TELE_SCORE,
        verbose_name = 'Frisbees Scored',
    )
    tele_hung = ArceeFields.MultiSelectField (
        blank = True,
    ...
    balance_capable = models.NullBooleanField (
        ...
        choices = RobotSpecs.NBOOL_CHOICES,
        verbose_name = 'Robot climbed',
        help_text = 'Robot climbed pyramid',
    )
    end_score = models.IntegerField (
        default = 0,
        choices = RobotSpecs.LEVELS,
